<template>
  <v-sheet rounded width="200" style="position: fixed; right: 1.6rem; bottom: 1.8rem" class="d-flex justify-space-between">
...
const { setViewport, getViewport, zoomIn, zoomOut } = useVueFlow({});

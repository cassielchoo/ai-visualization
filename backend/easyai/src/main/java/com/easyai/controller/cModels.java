...
public class cModels {
    ...
    public String kmeans(@RequestBody Map<String, Object> params) {
        ...
        try {
            if (params != null) {
                ...
                result.setCode(200);
                result.setMsg("OK");
                Map<String, Map> returnMap = RandomForest_K_means.K_means(NUmClusters);
                result.setData(returnMap);
    ...
    public String randomForest(@RequestBody Map<String, Object> params) {
        ...
        try {
            if (params != null) {
                ...
                result.setCode(200);
                result.setMsg("OK");
                Map<String, Map> returnMap = RandomForest_K_means.RandomForest(NumTrees, depth, NumSeed, NumAttribute);
                result.setData(returnMap);
    ...
    public String catboost() {
        ...
        try {
            result.setCode(200);
            result.setMsg("OK");
            Map<String, Map> returnMap = Catboost.catboost();
            result.setData(returnMap);
    ...
    public String CNN(@RequestBody Map<String, Object> params) {
        ...
        try {
            if (params != null) {
                ...
                result.setCode(200);
                result.setMsg("OK");
                Map returnMap = CNN.CNNmodel(learningRate, batchSize, nEpochs, numHiddenNodes);
                result.setData(returnMap);
    ...
    public String fullConnect(@RequestBody Map<String, Object> params) {
        ...
        try {
            if (params != null) {
                ...
                result.setCode(200);
                result.setMsg("OK");
                Map<String, Map> returnMap = FullConnect.FullConnect(learningRate, batchSize, nEpochs, numHiddenNodes);
                result.setData(returnMap);
        ...
        try {
            if (params != null) {
                ...
                if (modelType.equals("CNN")) {
                    ...
                    result.setMsg("OK");
                    Map<String, String> returnMap = new HashMap<>();
                    returnMap.put("result", String.valueOf(pred.get_flowerclass(sepal_length, sepal_width, petal_length, petal_width)));
                    result.setData(returnMap);
                    ...
                    Map<String, String> returnMap = new HashMap<>();
                    returnMap.put("Error", "Model" + modelType + "Not Found");
                    result.setData(returnMap);
    ...
    public String RNN(@RequestBody Map<String, Object> params) {
        ...
        try {
            if (params != null) {
                ...
                result.setCode(200);
                result.setMsg("OK");
                Map<String, Map> returnMap = RNN.rnn(nEpochs);
                result.setData(returnMap);
